...
class KorespondenController extends Controller
{
    ...
    {
        $user = Auth::user();
        return view('berita.koresponden-create',compact('user'));
    }
    ...
    public function show(Koresponden $koresponden)
    {
        ...
        return view('berita.form-berita-koresponden', compact('korespondens','user'));
    }
    ...
    public function edit(Koresponden $koresponden, $id_koresponden)
    {
        ...
        return view('berita.koresponden-edit', compact('koresponden','user'));
    }
