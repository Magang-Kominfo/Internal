...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/menambahkanAsetAplikasi-uc-1.css">
    <title>Menambahkan Aset Aplikasi</title>
</head>
                ...
                <div class="uc-1-menambahkan-aset-aplikasi-view-artikel">
                    <div class="uc-1-menambahkan-aset-aplikasi-view-artikel-aset-aplikasi">
                        <div class="uc-1-menambahkan-aset-aplikasi-view-artikel-aset-aplikasi-header">
                            <h1>MENAMBAHKAN ASET APLIKASI</h1>
                        </div>

                        <form action="{{ route('tambah-aset-aplikasi.post') }}" method="post">
                        @csrf
