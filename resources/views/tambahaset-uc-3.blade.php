...
<body id="bodyAll" style="background-color:#F1F1F3">
    ...
    <div class="bodyTambahAset" style="background-color: white" >
        <div class="judul">
        <h3>Menambahkan Aset</h3>
        </div>

        <form class="formaset" action="/tambahaset" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-6 offset-3">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="nomor_aset" name="nomor_aset" placeholder="" style="border:1px solid #34469A">
                    <label for="nomor_aset">Nomor Aset:</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="namaaset" style="border:1px solid #34469A">
                    <label for="nama">Nama Aset</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="jumlah" name="jumlah" placeholder="" style="border:1px solid #34469A">
                    <label for="jumlah">Jumlah Aset</label>
                </div>
              
                <div class="form-group mb-3">
                    <label class="form-label" for="pemanfaatan">Pemanfaatan Aset</label>
                    <textarea class="form-control" id="pemanfaatan" name="pemanfaatan" rows="3" style="border:1px solid #34469A"></textarea>
                </div>
                <div class="form-group mb-3">
                    <label class="form-label" for="kondisi">Kondisi Aset</label>
                    <textarea class="form-control" id="kondisi" name="kondisi" rows="3" style="border:1px solid #34469A"></textarea>
                </div>
